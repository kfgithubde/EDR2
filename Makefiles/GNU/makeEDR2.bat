...
REM %FlexBase%\windres.exe -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu  -J rc -O coff -i resource.rc -o obj\resource.res
%GCCbinBase%\g++.exe -L%wxBase%\lib\gcc_lib -L%GCClibBase% -o EDR2.exe obj\ButterworthTime.o obj\EDRplot.o obj\EDR2App.o obj\EDR2Main.o obj\ReadCrashData.scanner.o  -s -mthreads -m64  libgraph2d.a -lwxmsw31u -lwxpng -lwxjpeg -lwxtiff -lwxzlib -lwxexpat -lkernel32 -luser32 -lgdi32 -lwinspool -lcomdlg32 -ladvapi32 -lshell32 -lole32 -loleaut32 -luuid -lcomctl32 -lwsock32 -lodbc32 -lshlwapi -lversion -loleacc -luxtheme -lgfortran -mwindows
